...
from src.database.db import get_all_students, create_teacher, create_student, get_student_attendance, get_student_subjects, unenroll_student_to_subject
        ...
        with st.spinner("AI is Scanning..."):
            ...
            if num_faces == 0:
                ...
                if detected:
                    ...
                    all_students = get_all_students()  # Fetch all students from the 
                    ...
                    st.info("Face not recognized. Please register your face.")
