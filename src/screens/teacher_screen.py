        ...
        for sub in subjects:
            ...
            def share_btn(subject=sub):
                if st.button(f"Share Code: {subject['name']}", key=f"share_{subject['subject_code']}", icon=":material/share:"):
                    share_subject_dialog(subject['subject_id'], subject['subject_code'])
                st.space()
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter Username", placeholder="nobita", key='teacherusername')
    teacher_password = st.text_input("Enter Password", placeholder="Enter your password", type='password', key='teacherpassword')
...
def register_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm):
    ...
    try:
        ...
        return True, "Teacher registered successfully! Please login."
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder='nobita')

    teacher_name = st.text_input("Enter name", placeholder='Nobita Mestry')
